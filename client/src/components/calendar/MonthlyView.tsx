...
import { getCalendarDays, isToday, isSameDay, toArabicNumerals } from "@/lib/hijri-utils";
        ...
        {days.map((day, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "min-h-24 p-2 rounded-md border transition-all duration-200 hover-elevate",
            ...
            >
              ...
              {dayEvents.length > 0 && (
                <div className="flex gap-1 mt-auto w-full flex-wrap justify-end" data-testid={`events-indicators-${dateKey}`}>
