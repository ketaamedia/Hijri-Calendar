...
import type { Event, InsertEvent, EventColor, FileDb, RecurrenceType } from "@shared/schema";
import { hijriMonthNames, eventColorSchema, recurrenceTypeSchema, recurrenceTypeNames } from "@shared/schema";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6" data-testid="form-event">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>نمط التكرار</FormLabel>
              <Select
                onValueChange={field.onChange}
                value={field.value}
              >
                ...
                <SelectContent>
                  {(Object.keys(recurrenceTypeNames) as RecurrenceType[]).map((type) => (
                    <SelectItem key={type} value={type} data-testid={`option-recurrence-${type}`}>
                      {recurrenceTypeNames[type]}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
        ...
        {recurrenceType !== "none" && (
          <div className="space-y-4 rounded-md border border-border p-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    كل {" "}
                    {recurrenceType === "daily" && "يوم"}
                    {recurrenceType === "weekly" && "أسبوع"}
                    {recurrenceType === "monthly" && "شهر"}
                    {recurrenceType === "yearly" && "سنة"}
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                  ...
                  <FormDescription>
                    {recurrenceType === "daily" && "تكرار كل عدد معين من الأيام"}
                    {recurrenceType === "weekly" && "تكرار كل عدد معين من الأسابيع"}
                    {recurrenceType === "monthly" && "تكرار كل عدد معين من الأشهر"}
                    {recurrenceType === "yearly" && "تكرار كل عدد معين من السنوات"}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>تاريخ انتهاء التكرار (اختياري)</FormLabel>
                  <FormControl>
                    <Input
                      type="date"
                      {...field}
